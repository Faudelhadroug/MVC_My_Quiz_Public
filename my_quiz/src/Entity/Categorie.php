...
class Categorie
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Historique", mappedBy="categorie")
     */
    private $historiques;
    ...
    public function removeHistorique(Historique $historique): self
    {
        if ($this->historiques->contains($historique)) {
            ...
            // set the owning side to null (unless already changed)
            if ($historique->getCategorie() === $this) {
                $historique->setCategorie(null);
            }
        }
