 ...
 */
final class Version20200502181810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE historique ADD secret VARCHAR(255) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE historique DROP secret, CHANGE user_id user_id INT DEFAULT NULL');
